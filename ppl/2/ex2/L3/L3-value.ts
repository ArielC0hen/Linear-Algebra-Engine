...
export const isSExp = (x: any): x is SExpValue =>
    ...
    isSymbolSExp(x) || isCompoundSExp(x) || isEmptySExp(x) || isPrimOp(x) || isClosure(x) || isClassValue(x) || isObjectValue(x);
...
export const ObjectValueToString = (c: ObjectValue): string => "Object";
