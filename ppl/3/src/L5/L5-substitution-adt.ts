...
import { eqTVar, isAtomicTExp, isProcTExp, isTVar, makeProcTExp, unparseTExp, TExp, TVar, isListTExp, makeListTExp } from "./TExp";
...
export const applySub = (sub: Sub, te: TExp): TExp =>
    ...
    isListTExp(te) ? makeListTExp(applySub(te.itemTE)) :
    te;
